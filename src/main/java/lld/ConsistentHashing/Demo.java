...
public class Demo {
    public static void main(String[] args) {
        ...
        Server server = map.getServerFromGivenKey("Nikhil");
        System.out.println(server.getIpAddress());


        map.put("Ritu", "Agrawal2");
        server = map.getServerFromGivenKey("Ritu");
        System.out.println(server.getIpAddress());
        ...
        map.removeServerFromHashRing(newServer1);

        // accessing key-value pair after stored server is deleted
        server = map.getServerFromGivenKey("Nikhil");
        System.out.println(server.getIpAddress());
